<%-- 
    Document   : profile
    Created on : Apr 22, 2012, 9:16:20 PM
    Author     : 13100173
--%>
            ...
            <div id="hmenu-wpr"> 
              <ul id="hmenu" class="sf-menu sf-js-enabled sf-shadow">
                ...
                <li class="current" style="border:none"> 
                  <a href="#" class="toplvl">Analysis</a>  
                </li>
                <li> 
            ...
            <div id="page"> 
              ...
              <div id="main"> 
                <div class="content"> 
                  ...
                  <h3></h3>  
                  <p> 
                    <img src="images/bizwoman-1.png" style="float:right;margin-left:20px" /> </p>  
                  <h2 style="margin-top:35px;">profile</h2>  
                  <p>Name:.</p>  
                  <p>City: </p>  
                  <p>Phone:</p>
                  <p>Name:.</p>  
			...
			<h2>Menu</h2>  
                    <div class="vmenu"> 
                      <ul>
                        ...
                        <li>
                          <a href="geo.html">Geographical Distribution</a>
                        </li>
                        <li>
                          <a href="disease.html">Data</a>
                        </li>
                      </ul> 
                    </div> 
                  </div>
