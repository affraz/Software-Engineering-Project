<%-- 
    Document   : register
    Created on : Apr 6, 2012, 12:22:45 PM
    Author     : Bhatti
--%>
...
<body id="main_body" >
	...
	<div id="form_container">
		...
		<form id="form_376987" class="appnitro"  method="post" action="">
...
<label class="choice" for="element_5_3">Transwoman</label>

		</span> 
		</li>		<li id="li_13" >
		<label class="description" for="element_13">AGE </label>
		<div>

			<input id="element_13" name="element_13" class="element text small" type="text" maxlength="255" value=""/> 
		</div> 
		</li>		<li id="li_9" >
		<label class="description" for="element_9">Marital Status </label>
		<span>
...
<label class="choice" for="element_9_4">Divoerced (separated)</label>
...
<input id="element_10_6" name="element_10" class="element radio" type="radio" value="6" />
<label class="choice" for="element_10_6">AB-</label>
<input id="element_10_7" name="element_10" class="element radio" type="radio" value="7" />
<label class="choice" for="element_10_7">O+</label>
<input id="element_10_8" name="element_10" class="element radio" type="radio" value="8" />
...
<label class="choice" for="element_25_2">No</label>
		...
		<div>
			<textarea id="element_28" name="element_28" class="element textarea medium"></textarea> 
		</div> 
		</li>		<li id="li_26" >
		<label class="description" for="element_26">Genetic Disorder </label>
		<div>
			<textarea id="element_26" name="element_26" class="element textarea medium"></textarea> 
		</div> 
		</li>		<li id="li_31" >
...
<label class="choice" for="element_31_1">YES</label>
		...
		<div>
			<input id="element_29" name="element_29" class="element text medium" type="text" maxlength="255" value=""/> 
					...
					<li class="buttons">
			    <input type="hidden" name="form_id" value="376987" />
